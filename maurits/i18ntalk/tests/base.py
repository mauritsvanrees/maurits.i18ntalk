...
def setup_product():
    ...
    import maurits.i18ntalk
    zcml.load_config('configure.zcml', maurits.i18ntalk)
    ...
    ztc.installPackage('maurits.i18ntalk')
...
setup_product()
ptc.setupPloneSite(products=['maurits.i18ntalk'])
